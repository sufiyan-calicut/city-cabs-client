      ...
      <div className="bg-zinc-900 w-full h-20 grid grid-cols-2 fixed z-10">
        ...
        <div className="col-span-1">
          <div className="flex justify-end items-center text-white  lg:mr-40 mt-5">
            <button className="hidden lg:block rounded-full py-2 px-6 md:ml-16 uppercase text-xs font-semibold cursor-pointer tracking-wider hover:bg-slate-400 hover:text-black hover:font-semibold duration-500" onClick={()=> navigate('/profile')}>
              PROFILE
            </button>

            <button className="lg:hidden rounded-full py-2 uppercase text-xs font-semibold cursor-pointer tracking-wider lg:hover:bg-slate-400 lg:hover:text-black hover:font-semibold duration-500" onClick={()=> navigate('/profile')}>
              <svg
            ...
            <button className="hidden lg:block rounded-full py-2 px-6 md:ml-16 uppercase text-xs font-semibold cursor-pointer tracking-wider hover:bg-slate-400 hover:text-black hover:font-semibold duration-500" onClick={logout}>
              LOGOUT
            </button>

            <button className="lg:hidden rounded-full py-2 px-6 md:ml-16 uppercase text-xs font-semibold cursor-pointer tracking-wider lg:hover:bg-slate-400 lg:hover:text-black hover:font-semibold duration-500" onClick={logout}>
              <svg
                className="fill-current"
                width="22"
                height="22"
